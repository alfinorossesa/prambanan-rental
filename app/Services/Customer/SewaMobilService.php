...
class SewaMobilService
{
    public function getKendaraan()
    {
        ...
        $kendaraan = DB::table('kendaraan')
                ...
                ->where('kendaraan.kategori', '=', 'mobil')
                ->latest()->paginate(20);
    ...
    public function getMobil($sewa)
    {
        $mobil = $sewa->with('kendaraan')->where('id', $sewa->id)->first();
    ...
    public function total($sewa)
    {
        ...
        $hargaSupir = $sewa->supir == 1 ? 100000 : 0;
        $hargaBBM = $sewa->bbm == 1 ? 100000 : 0;
