...
<section class="bg-body masthead">
    <div class="container-fluid px-5">
        <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
            <div class="col-md-12">
                <h3 class="lh-1 mb-4 text-center">Form Pemesanan Sewa Motor</h3>
            </div>                
        </div>
    </div>
    <div class="container mt-5">
        <form action="{{ route('sewa-motor.store', $kendaraan->id) }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex float-end">
                        <div class="mx-2">
                            <a href="{{ route('sewa-motor.index') }}" class="btn btn-sm btn-dark">Batal</a>
