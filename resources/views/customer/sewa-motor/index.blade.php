...
<section class="bg-body masthead">
    <div class="container-fluid px-5">
        <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
            <div class="col-md-4">
                <h3 class="lh-1 mb-4 text-center">Daftar Motor</h3>
            </div>
            <div class="col-md-4">
                <div class="input-group mb-3">
                    <form action="{{ route('sewa-motor.index') }}">
                ...
                @foreach ($kendaraan as $item)
                    <div class="col-md-3 mb-5">
                        <div class="text-center">
                            ...
                            <a class="btn btn-sm bg-darkblue-custom text-white rounded-pill mt-2" href="{{ route('sewa-motor.pesan', $item->id) }}">Pesan</a>
                        </div>
                    </div>
                @endforeach
            </div>
