...
<div class="card shadow my-3 mb-5 mx-5">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Data Paket Wisata</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('data-paket-wisata.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_paket') is-invalid @enderror" id="nama_paket" name="nama_paket" value="{{ old('nama_paket') }}" placeholder="Masukkan Nama Paket" required>
                @error('nama_paket')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('tujuan') is-invalid @enderror" id="tujuan" name="tujuan" value="{{ old('tujuan') }}" placeholder="Masukkan Tujuan" required>
                @error('tujuan')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group" id="select-fasilitas">
                <div class="col-md-8">
                    <select name="fasilitas[]" id="multipleselect" class="custom-select multipleselect @error('fasilitas') is-invalid @enderror" multiple aria-label="multiple select example" required></select>
                </div>
                @error('fasilitas')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="row d-flex  align-items-center justify-content-center pt-5">  
                <img src="{{ asset('template-admin/img/no-image-vertical.jpg') }}" alt="" class="img-preview tambah-paket-wisata">
            </div>
