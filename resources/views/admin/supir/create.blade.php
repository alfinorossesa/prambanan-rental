...
<div class="card shadow mt-3 mx-5">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Supir</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('supir.store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik" value="{{ old('nik') }}" placeholder="Masukkan NIK" required>
                @error('nik')
